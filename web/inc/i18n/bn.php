...
$LANG['en'] = array(
    ...
    'DISK'  => 'ডিস্ক',
    'NETWORK'  => 'নেটওয়ার্ক',
    'Web Log Manager'  => 'ওয়েব লগ ব্যাবস্থাপনা',

    'no notifications'  => 'কোনো বার্তা নেই',

    'Add User'  => 'ব্যাবহারকারি যোগ করুন',
    'Add Domain'  => 'ডোমেইন যোগ করুন',
    'Add Web Domain'  => 'ডোমেইন যোগ করুন',
    'Add DNS Domain'  => 'ডিএনএস ডোমেইন যোগ করুন',
    'Add DNS Record'  => 'ডিএনএস রেকর্ড যোগ করুন',
    'Add Mail Domain'  => 'মেইল ডোমেইন যোগ করুন',
    'Add Mail Account'  => 'মেইল ব্যাবহারকারি যোগ করুন',
    'Add Database'  => 'ডাটাবেস যোগ করুন',
    'Add Cron Job'  => 'কর্ন জব যোগ করুন',
    'Create Backup'  => 'ব্যাকআপ নিন',
    'Configure'  => 'কনফিগার করুন',
    'Restore All'  => 'সবকিছু ফিরিয়ে আনুন',
    'Add Package'  => 'একটি প্যাকেজ তৈরি করুন',
    'Add IP'  => 'আইপি এ্যাড্রেস যোগ করুন',
    'Add Rule' => 'একটি নীতিমালা যোগ করুন',
    'Ban IP Address' => 'আইপি বহিস্কার করুন',
    'Search'  => 'খুঁজুন',
    'Add one more FTP Account' => 'আরও একটি এফটিপি ব্যাবহারকারি যোগ করুন',
    'Overall Statistics'  => 'সর্বাত্বক পরিসংথ্যান',
    'Daily'  => 'প্রতিদিন',
    'Weekly'  => 'প্রতিসপ্তাহে',
    'Monthly'  => 'প্রতিমাসে',
    'Yearly'  => 'প্রতি বছরে',
    ...
    'toggle all'  => 'সবকিছু নির্বাচন করুন / বাদ দিন',
    'apply to selected'  => 'নির্বাচিত গুলোতে প্রয়োগ করুন',
    'rebuild'  => 'নতুন করে তৈরি করুন',
    'rebuild web'  => 'নতুন করে ওয়েব তৈরি করুন',
    'rebuild dns'  => 'নতুন করে ডিএনএস তৈরি করুন',
    'rebuild mail'  => 'নতুন করে মেইল তৈরি করুন',
    'rebuild db'  => 'নতুন করে ডাটাবেস তৈরি করুন',
    'rebuild cron'  => 'নতুন করে কর্ন তৈরি করুন',
    'update counters'  => 'কাউন্টার হালনাগাদ করুন',
    'suspend'  => 'বন্ধ করুন',
    'unsuspend'  => 'চালু করুন',
    'delete'  => 'মুছে ফেলুন',
    'show per user'  => 'প্রত্যেক ব্যাবহারকারির হিসেবে দেখান',
    'login as'  => 'যে নামে লগিন করতে চান',
    'logout'  => 'লগ আউট',
    'edit'  => 'edit',
